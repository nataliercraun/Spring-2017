...
{
    Product* newbook = new Book(isbn_, author_, "book", prodName_, price_, qty_); 
    return newbook; 
}
...
{
    Product* newcloth = new Clothing(size_, brand_, "clothing", prodName_, price_, qty_);
    return newcloth; 
}
...
{
    Product* newmovie = new Movie(genre_, rating_, "movie", prodName_, price_, qty_);
    return newmovie; 
}
